...
Respuesta:
  ...
  * El [perceptrón]([url](https://es.wikipedia.org/wiki/Perceptr%C3%B3n)) inspirado en la neurona. (Dados los últimos avances en neurociencia, ¿habría que inspirarse también en las [células gliales]([url](https://es.wikipedia.org/wiki/C%C3%A9lula_glial#:~:text=Las%20c%C3%A9lulas%20gliales%20desempe%C3%B1an%2C%20de,y%20otros%20factores%20de%20crecimiento.))?)
  * El salto que han dado los modelos de lenguaje gracias a los modelos [Transformers]([url](https://en.wikipedia.org/wiki/Transformer_(machine_learning_model))) para dotarles de atención al contexto (superando las redes neuronales recurrentes). Acercan los modelos de lenguaje a la [hermenéutica]([url](https://es.wikipedia.org/wiki/Hermen%C3%A9utica)) humana en una especie de [círculo hermenéutico]([url](https://es.wikipedia.org/wiki/C%C3%ADrculo_hermen%C3%A9utico)) en el cual el propio entendimiento del texto se ve retroalimentado por el contexto del ínterprete y del propio texto. (Ver crítica de [Hubert Dreyfus]([url](https://es.wikipedia.org/wiki/Hubert_Dreyfus)) a los cuatro supuestos de la IA para más detalle sobre la importancia del contexto).
...
- Pájaros bandada
- Hormigas
- Ecuaciones diferenciales que describen sistemas autoorganizados y que se deben resolver de forma holística. Ejemplo de ecuaciones de [Navier-Stokes]([url](https://es.wikipedia.org/wiki/Ecuaciones_de_Navier-Stokes)).
- Mente vs Neuronas
